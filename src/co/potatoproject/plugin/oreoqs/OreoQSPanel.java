...
import com.android.systemui.qs.QSPanel.Record;
...
public class OreoQSPanel extends QSPanel {
    ...
    public OreoQSPanel(Context context) {
        this(context, null);
    }

    public OreoQSPanel(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    protected TileRecord addTile(final QSTile tile, boolean collapsedView) {
        ...
        final QSTile.Callback callback = new QSTile.Callback() {
            ...
            public void onShowDetail(boolean show) {
                ...
                if (shouldShowDetail()) {
                    OreoQSPanel.this.showDetail(show, r);
                }
            }
