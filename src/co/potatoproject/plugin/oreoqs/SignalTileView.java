...
import co.potatoproject.plugin.oreoqs.tileimpl.QSIconViewImpl;
import co.potatoproject.plugin.oreoqs.tileimpl.SlashImageView;
...
public class SignalTileView extends QSIconViewImpl {
    ...
    @Override
    public void setIcon(QSTile.State state, boolean animate) {
