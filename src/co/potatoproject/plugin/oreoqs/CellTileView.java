...
package co.potatoproject.plugin.oreoqs;
...
import co.potatoproject.plugin.oreoqs.tileimpl.QSTileUtils;
...
public class CellTileView extends SignalTileView {
    ...
    public CellTileView(Context context) {
        ...
        mSignalDrawable.setColors(QSTileUtils.getColorForState(context, Tile.STATE_UNAVAILABLE),
                QSTileUtils.getColorForState(context, Tile.STATE_ACTIVE));
    ...
    public static class SignalIcon extends Icon {
        ...
        public Drawable getDrawable(Context context) {
            ...
            d.setColors(QSTileUtils.getColorForState(context, Tile.STATE_UNAVAILABLE),
                    QSTileUtils.getColorForState(context, Tile.STATE_ACTIVE));
            d.setLevel(getState());
            return d;
        }
