...
package co.potatoproject.plugin.oreoqs.tiles;
...
import co.potatoproject.plugin.oreoqs.CellTileView;
import co.potatoproject.plugin.oreoqs.CellTileView.SignalIcon;
...
public class CellularTile extends QSTileImpl<SignalState> {
    ...
    public CellularTile(QSHost host) {
        ...
        mUnlockMethodCache = Dependency.get(UnlockMethodCache.class);
    ...
    private final class CellSignalCallback implements SignalCallback {
        ...
        public void setMobileDataIndicators(IconState statusIcon, IconState qsIcon, int statusType,
            ...
            mInfo.dataContentDescription = String.valueOf(typeContentDescription);
            mInfo.activityIn = activityIn;
            mInfo.activityOut = activityOut;
            mInfo.enabledDesc = String.valueOf(description);
